...
@section('script-src', asset('public/admin-assets/pages/manage-o2bbill.js'))
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4>{{ $heading }}</h4></div>
                                <div class="col-6"><a href="{{ $actionUrl }}" class="btn btn-primary pull-right" data-url="{{ $redirectUrl }}"><i class="fas fa-plus"></i>Create</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="dealer-table" data-url="{{ $redirectUrl }}">
                                        <thead>
                                        <tr>
