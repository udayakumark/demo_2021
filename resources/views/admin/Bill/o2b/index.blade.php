                                                ...
                                                @foreach ($salesitems as $vendor)
                                                 <?php $i++; ?>
                                                    <tr id='addr<?php echo $i ?>' >
                                                        <td><?php echo $i ?></td>
														<td>
                                                        <select class="form-control select2" name="product_id[]" id="product_name<?php echo $i ?>" required>
        ...
        $(document).ready(function(){
            $("#add_row").click(function(){
                ...
                $('#addr').append(`<tr id='addr`+i+`' >
                                                    <td>`+sno+`</td>
														<td>
														 <select class="form-control select2" name="product_id[]" id="product_name`+sno+`" required>
														 <option value="">Select Product</option>
														@foreach ($otherProductsList as $otherProducts)
                                                                    <option value="{{ $otherProducts['id'] }}" {{ $otherProducts['id'] ==$vendor['paddy_id'] ? 'selected' : '' }} >{{ $otherProducts['name'] }}</option>
                                                         @endforeach
