...
@section('title', 'Manage Online Payment ')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-8"><h4>Online Payment</h4></div>
                                <div class="col-4">
                                    <a href="{{ url('admin/create-online-payment') }}" class="btn btn-primary pull-right"><i class="fas fa-plus"></i> Create</a>
                            ...
                            <div class="card-body">
                                    ...
                                    <form name="search-form" id="SearchForm" method="post" action="#">
                                        <div class="form-row">
                                            <div class="col-md-4 form-group">
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Enter the Bank name or Account name">
                                            </div>
                                            <div class="col-md-4 form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="dealer-table" data-url="{{ url('/admin/online-payment-list') }}">
                                        <thead>
                                        <tr>
