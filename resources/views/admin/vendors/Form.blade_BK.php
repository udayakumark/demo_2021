                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url($action) }}" redirect-url="{{ url($redirectUrl) }}" id="form" novalidate="">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label>City</label>
                                            <select class="form-control select2" name="city" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label>Pincode</label>
                                            <input type="number" max="6" name="pincode" autocomplete="OFF" placeholder="Enter Pincode" class="form-control" value="{{ $usermodel->pincode }}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Address</label>
