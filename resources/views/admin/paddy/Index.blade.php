...
@section('title', 'Manage Paddy Types')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-8"><h4>Manage Paddy Types</h4></div>
                                <div class="col-4">
                                    <a href="{{ url('admin/create-paddy') }}" class="btn btn-primary pull-right"><i class="fas fa-plus"></i> Create</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="dealer-table" data-url="{{ url('/admin/paddy-list') }}">
                                        <thead>
                                        <tr>
