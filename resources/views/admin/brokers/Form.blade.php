...
@section('title', $name.' Broker')
@section('script-src', asset('public/admin-assets/pages/manage-vendors.js'))
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-8"><h4>{{ $name }} Broker</h4></div>
                                <div class="col-4">
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url($action) }}" redirect-url="{{ url($redirectUrl) }}" id="form" novalidate="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="first_name" placeholder="Enter First Name" class="form-control" value="{{ $usermodel->first_name }}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Last Name</label>
                                            <input type="text" name="last_name" placeholder="Enter Last Name" class="form-control" value="{{ $usermodel->last_name }}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Email Id</label>
                                            <input type="text" name="email_id" placeholder="Enter Email-ID" class="form-control"  autocomplete="OFF" value="{{ $model->email_id }}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                        ...
                                        @if($type==1)
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input type="text" name="user_name" placeholder="Enter User Name" class="form-control" autocomplete="OFF" value="{{ $model->user_name }}">
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <label>Password</label>
                                                <input type="password" name="password" placeholder="Enter Password" class="form-control"  autocomplete="OFF" value="{{ $model->password }}">
                                            </div>
                                        @endif
                                        <div class="col-md-3 form-group">
                                            <label>Dob</label>
