                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-8"><h4>{{ $name }} Bag Type</h4></div>
                                <div class="col-4">
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url($action) }}" redirect-url="{{ url($redirectUrl) }}" id="form" novalidate="">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 form-group text-center">
                                            <a href="{{ url('/admin/bag') }}" class="btn btn-danger btn-lg back"><i class="fas fa-arrow-left"></i> Back</a>
