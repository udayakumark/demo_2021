                                                ...
                                                @foreach ($salesitems as $vendor)
                                                 <?php $i++; ?>
                                                    <tr id='addr<?php echo $i ?>' >
                                                        <td><?php echo $i ?></td>
                                                        <td><select class="form-control select2" name="product_id[]" id="product_name<?php echo $i ?>" required>
														 <option value="">Select Accessories</option>
														@foreach ($accessoriesList as $accessories)
                                                                    <option value="{{ $accessories['id'] }}" {{ $accessories['id'] ==$vendor['paddy_id'] ? 'selected' : '' }} >{{ $accessories['name'] }}</option>
                                                         @endforeach
                                                        </select>
                                                    </td>
