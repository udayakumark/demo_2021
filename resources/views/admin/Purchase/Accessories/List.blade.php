...
@section('title', 'Manage Accessories Purchases')
@section('script-src', asset('public/admin-assets/pages/manage-accessoriespurchase.js'))
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4>Manage Accessories Purchases</h4></div>
                                <div class="col-6"><a href="{{ url('accessories/purchase/add') }}" class="btn btn-primary pull-right" data-url="{{ url('accessories/purchase/add') }}"><i class="fas fa-plus"></i>Create</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="dealer-table" data-url="{{ url('accessories/purchase/list') }}">
                                        <thead>
                                        <tr>
