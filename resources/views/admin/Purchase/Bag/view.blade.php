                                            ...
                                            <table class="table table-bordered table-hover" id="tab_logic">
                                                ...
                                                @foreach ($salesitems as $vendor)
                                                 <?php $i++; ?>
													...
													<td class="text-center"><?php echo ($vendor['paddy_id']==11) ? 'Paddy' : 'Rice'; ?></td>
                                                    <td class="text-center"><?php echo $vendor['wgt']; ?>@foreach ($riceList as $rice)
													{{ $rice['id'] ==$vendor['wgt'] ? $rice['name'] : '' }}
                                                         @endforeach</td>
