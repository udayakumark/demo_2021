...
@section('title', 'Manage Bag Purchases')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4>Manage Bag Purchases</h4></div>
                                <div class="col-6"><a href="{{ url('bag/purchase/add') }}" class="btn btn-primary pull-right" data-url="{{ url('bag/purchase/add') }}"><i class="fas fa-plus"></i>Create</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="dealer-table" data-url="{{ url('bag/purchase/list') }}">
                                        <thead>
                                        <tr>
