                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="paddy_purchase_form" action="{{ url($actionUrl) }}" redirect-url="{{ url($redirectUrl) }}" method="POST">
                                    {{ csrf_field() }}
									<div class="row">
                                        <div class="col-lg-12 mb-4">
                                            <div class="form-group">
                                                <label for="username">Purchase Source</label>
												 @if($purchase_action=='Edit')
													<h5>{{ $inv_details['purchase_source']==1 ? 'Own' : 'Third Party' }}</h5>
												 @else
													<input class="form-control" type="radio" name="purchase_source" id="purchase_source_own" value="1" required="" required {{ $inv_details['purchase_source']==1 ? 'checked="checked"' : '' }} {{ $purchase_action=='Edit' ? 'disabled="disabled"' : '' }}>Own
													<input class="form-control" type="radio" name="purchase_source" id="purchase_source_vendor" value="2" required="" required {{ $inv_details['purchase_source']==2 ? 'checked="checked"' : '' }} {{ $purchase_action=='Edit' ? 'disabled="disabled"' : '' }}>Third Party
												 @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="invoice_no" id="invoice_no"  autocomplete="OFF" required="" required value="<?php echo $inv_details['invoice_no'] ?>" {{ $purchase_action=='Edit' ? 'disabled="disabled"' : '' }}>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="broker">
                                                    ...
                                                    @foreach ($brokerlist as $vendor)
                                                        <option value="{{ $vendor['id'] }}" {{ $vendor['id']==$inv_details['broker_id'] ? 'selected' : '' }}>{{ $vendor['first_name']." ". $vendor['last_name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="veh_no" id="veh_no"  autocomplete="OFF" value="<?php echo $inv_details['veh_no']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-hover  table-responsive" id="tab_logic">
                                                ...
                                                @foreach ($salesitems as $vendor)
                                                 <?php $i++; ?>
                                                        ...
                                                        <select class="form-control select2" name="product_id[]">
                                                            <option value="">Select Paddy</option>
                                                                @foreach ($productList as $category)
                                                                    <option value="{{ $category->id }}" {{ $category->id ==$vendor['paddy_id'] ? 'selected' : '' }} >{{ $category->name }}</option>
                                                                @endforeach
                                                        </select>
                                                    </td>
                                                    <td><input type="text" name='wgt[]' placeholder='Enter the weight' class="form-control weight" step="0" min="0" autocomplete="OFF" required  value="<?php echo $vendor['wgt']; ?>"/></td>
                                                    ...
                                                    <td><input type="text" name='totalwgt[]' placeholder='' class="form-control totalweight" value="<?php echo $vendor['totalwgt']; ?>" autocomplete="OFF" readonly /></td>
													<td class="purchase_source_vendor_items"><input type="text" name='rate[]'  placeholder='Enter the rate' class="form-control rate" autocomplete="OFF" step="0.00" min="0"  value="<?php echo $vendor['rate']; ?>" /></td>
                                                    <td class="purchase_source_vendor_items"><input type="text" name='total[]' placeholder='0.00' class="form-control total" autocomplete="OFF" readonly  value="<?php echo $vendor['total']; ?>" /></td>
                                    ...
                                    <div class="row clearfix" style="margin-top:20px">
                                        ...
                                        <div class="pull-right col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="weigh1" id="weigh1"  autocomplete="OFF" value="<?php echo $inv_details['weigh1']; ?>">

                                            </div>
                                            <div class="form-group">
                                                <label for="username">Weigh 2nd:</label>
                                                <input class="form-control" type="text" name="weigh2" id="weigh2"  autocomplete="OFF" value="<?php echo $inv_details['weigh2']; ?>">

                                            </div>
                                            <div class="form-group">
                                                <label for="username">Weigh 3rd:</label>
                                                <input class="form-control" type="text" name="weigh3" id="weigh3"  autocomplete="OFF" value="<?php echo $inv_details['weigh3']; ?>">
                                        ...
                                        <div class="pull-right col-md-4">
                                            <table class="table table-bordered table-hover" id="tab_logic_total">
                                                ...
                                                <tr class="purchase_source_vendor">
                                                    <th class="text-center">Broker Commission <input type="text" name='bro_comm' placeholder='0.00' class="form-control" id="bro_comm" onkeyup="return calc_total();" autocomplete="OFF" value="<?php echo $inv_details['bro_comm']; ?>"></th>
                                                    <td class="text-center"><input type="number" name='bro_comm_total' placeholder='0.00' class="form-control" id="bro_comm_total" readonly  value="<?php echo $inv_details['bro_comm_total']; ?>"></td>
                                                </tr>
												<tr class="purchase_source_vendor">
