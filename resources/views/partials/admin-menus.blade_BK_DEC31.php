        ...
        <aside id="sidebar-wrapper">
          ...
          <nav class="sidebar py-2 mb-4">
            <ul class="nav flex-column" id="nav_accordion">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/vendors') }}"> <i data-feather="users" style="width: 17px"></i>  Manage Vendors</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item has-submenu">
                ...
                <ul class="submenu collapse">
				  <li><a class="nav-link" href="{{ url('stock/other') }}"><i data-feather="grid" style="width: 17px"></i> Accessories</a></li>
