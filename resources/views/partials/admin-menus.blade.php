            ...
            <ul class="nav flex-column" id="nav_accordion">
              ...
              <li class="nav-item">
                ...
                <ul class="submenu collapse {{ $masterShow }}">
                  ...
                  <li><a class="nav-link {{ ($url_seg2 =='admin/hsncode' ? 'nav-active':'' ) }}" href="{{ url('admin/hsncode') }}"><i data-feather="package" style="width: 17px"></i> HSN Code</a> </li>
              ...
              <li class="nav- item">
                ...
                <ul class="submenu collapse {{ ($url_seg3 =='bill' ? 'show':'' ) }} {{ ($url_seg2 =='other-expense' ? 'show':'' ) }}">
                  ...
                  <li><a class="nav-link {{ ($url_seg2 =='p2b' ? 'nav-active':'' ) }}" href="{{ url('admin/p2b/bill') }}"><i data-feather="package" style="width: 17px"></i><span> Paddy Bills</span> </a> </li>
                  <li><a class="nav-link {{ ($url_seg2 =='other-expense' ? 'nav-active':'' ) }}" href="{{ url('admin/other-expense') }}"><i data-feather="package" style="width: 17px"></i><span> Other Expense</span></a></li>
                </ul> 
              </li> 
			  <li class="nav- item">
                ...
                <ul class="submenu collapse {{ ($url_seg3 =='bill' ? 'show':'' ) }}">
				  <li><a class="nav-link {{ ($url_seg2 =='b2bd' ? 'nav-active':'' ) }}" href="{{ url('admin/b2bd/bill') }}"><i data-feather="package" style="width: 17px"></i><span> Rice Mill B2B </span></a></li>
				  <li><a  class="nav-link {{ ($url_seg2 =='b2cd' ? 'nav-active':'' ) }}" href="{{ url('admin/b2cd/bill') }}"><i data-feather="package" style="width: 17px"></i><span> Rice Mill B2C </span></a></li>
				  <li> <a class="nav-link {{ ($url_seg2 =='o2bd' ? 'nav-active':'' ) }}" href="{{ url('admin/o2bd/bill') }}"><i data-feather="package" style="width: 17px"></i><span> Other Bills </span></a> </li>
				  <li> <a class="nav-link {{ ($url_seg2 =='p2bd' ? 'nav-active':'' ) }}" href="{{ url('admin/p2bd/bill') }}"><i data-feather="package" style="width: 17px"></i><span> Paddy Bills </span></a> </li>
                </ul>                
              </li>
              ...
              <li class="nav-item has-submenu">
                ...
                <ul class="submenu collapse {{ ($url_seg1 =='stock' ? 'show':'' ) }}">				  
                 ...
                 <li><a class="nav-link {{ ($url_seg2 =='accessory-manual' ? 'nav-active':'' ) }}" href="{{ url('stock/accessory-manual') }}"><i data-feather="grid" style="width: 17px"></i> Accessory Manual </a></li>
