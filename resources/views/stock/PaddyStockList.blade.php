...
@section('title', 'Paddy Stock List')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4> Paddy Stock</h4></div>
                                <div class="col-6">
                                    <!-- <a href="{{ url('purchase/add') }}" class="btn btn-primary pull-right" data-url="{{ url('purchase/add') }}"><i class="fas fa-plus"></i>Create</a> -->
                            ...
                            <div class="card-body">
                                ...
                                <!-- <form name="search-form" id="paddy_purchase_form" method="post" action="#"> -->
                                    ...
                                    <table class="table table-striped" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left">Paddy Items</th>
                                                <th class="text-center">Weight</th>
                                                <th class="text-center">Quantity</th>
                                                <th class="text-center">Rate</th>
                                                <th class="text-center">Total Amount</th>
                                                <th class="text-center">Bill History</th>
                                            </tr>
                                        </thead>
                                        
                                        <?php $weight = 0; $qty = 0; $rate = 0;  $total_amt = 0; $sno= '1';?>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$datas->warehousesname }} </td>
                                                ...
                                                @if ( $datas->paddyItem ) 
                                                <td>{{ $datas->paddyItem }}</td>
                                                @endif

                                                @if ( $datas->weight ) 
                                                <td style="text-align:center">{{ $datas->weight }}</td>
                                                @endif
                                            ...
                                            <td style="text-align:center">@if ( $datas->total_amt ) ₹ {{ number_format($datas->total_amt,2) }} @endif</td>
                                             <td style="text-align:center">
                                                    <a href="{{url($historyUrl)}}/{{$datas->paddy_id}}/{{$datas->wh_id}}" title="View" class="btn btn-icon btn-sm btn-info update-button"><i class="fas fa-eye"></i></a>
                                                </td> 
                                            </tr>    
                                            <?php $qty += $datas->qty; 
                                                  $weight += $datas->weight;
