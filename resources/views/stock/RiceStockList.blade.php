                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4> Rice Stock</h4></div>
                                <div class="col-6">
                                    ...
                                    <table class="table table-striped" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left">Rice Name (KG)</th>
                                        ...
                                        <tr>
                                            ...
                                            @if ( $datas->ricename ) 
                                                {{ $datas->ricename}} - {{ $datas->kg}}                                              
                                            @endif  
                                            </td>
                                                
                                            <td style="text-align:center">@if ( $datas->qty ) {{ $datas->qty }} @endif</td>
                                            <td style="text-align:center">
                                            <a href="{{url($historyUrl)}}/{{$datas->rice_id}}/{{$datas->wh_id}}" title="View" class="btn btn-icon btn-sm btn-info update-button"><i class="fas fa-eye"></i></a>
                                            </td>   
                                        ...
                                        @else if
                                        <tr>
                                            <th class="text-center" colspan="5"> No records</th>
                                        </tr>
                                        @endif
                                    </table>
                               </div>
