...
@section('title', 'Accessories Stock List')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-6"><h4> Accessories Stock</h4></div>
                                <div class="col-6">                                
                                <a href="{{url('/stock/accessory-manual') }}" class="btn btn-primary btn-lg back pull-right"><i class="fas fa-arrow-right"></i> Accessory History</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <!-- Advanced searchForm -->
                                    ...
                                    <table class="table table-striped" >
                                        ...
                                        <tr>
                                            ...
                                            @endif  
                                                ...
                                                <td style="text-align:center">@if ( $datas->qty ) {{ $datas->qty - $datas->used_qty }}  @endif</td>
