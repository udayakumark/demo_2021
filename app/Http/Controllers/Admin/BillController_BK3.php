...
class BillController extends Controller
{
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'B2b Tax Bill Details Created Successfully.']);
					} else {
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'B2b Tax Bill Details Updated Successfully.']);
	 				} else {
    ...
    public function B2bdDelete(Request $request) {
        ...
        { 
             $model->status       = 0;
             $model->save();
            return response()->json(['success'=>'B2b Tax Details Deleted Successfully.']);
        } 
        else
        {
            return response()->json(['error'=>'Invalid Request. Try Again.']);
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'B2c Tax Bill Details Created Successfully.']);
					} else {
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'B2c Tax Bill Details Updated Successfully.']);
	 				} else {
    ...
    public function B2cdDelete(Request $request) {
        ...
        { 
             $model->status       = 0;
             $model->save();
            return response()->json(['success'=>'B2c Tax Bill Details Deleted Successfully.']);
        } 
        else
        {
            return response()->json(['error'=>'Invalid Request. Try Again.']);
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'O2b Tax Bill Details Created Successfully.']);
					} else {
		...
		if(isset($_POST['_token']))
        {
			...
			if($validator->passes())
			{
				...
				if($model->save())
				{
					...
					if ($model && $SalesItem){
						return response()->json(['success'=>'O2b Tax Bill Details Updated Successfully.']);
	 				} else {
	 					return response()->json(['singleerror'=>'Failed to Update O2b Tax Bill information. Try again after sometime.']);
					}
	 			} else {
	 				return response()->json(['singleerror'=>'Failed to Updat O2b Tax Bill information. Try again after sometime.']);
	 			}
			}
			else {
				return response()->json(['error'=>$validator->errors()->all()]);
