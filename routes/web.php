...
use App\Http\Controllers\Stock\AccessoryStockManualController;
...
Route::middleware(['admin'])->group(function(){
	...
	//Bill P2b
    Route::get('admin/p2b/bill', [BillController::class,'P2bIndex']);
	Route::post('p2b/bill/list',  [BillController::class,'P2bList']);
	Route::match(['get','post'],'p2b/bill/add/', [BillController::class,'P2bAdd']);
	Route::match(['get','post'],'admin/p2b/bill-view/{bill_id}', [BillController::class,'P2bView']);
	Route::match(['get','post'],'admin/p2b/bill-edit/{bill_id}', [BillController::class,'P2bEdit']);
	Route::post('admin/p2b-delete', [BillController::class,'P2bDelete']);
    Route::get('admin/p2b/bill-print/{bill_id}',  [BillController::class,'P2bPrint']);
	Route::get('p2b/bill/getVendordetails',  [BillController::class,'getVendordetailsp2b']);
    Route::get('p2b/bill/getRicedetails/{rice_id}',  [BillController::class,'getRicedetailsp2b']);
	
	//Bill P2bd
    Route::get('admin/p2bd/bill', [BillController::class,'P2bdIndex']);
	Route::post('p2bd/bill/list',  [BillController::class,'P2bdList']);
	Route::match(['get','post'],'p2bd/bill/add/', [BillController::class,'P2bdAdd']);
	Route::match(['get','post'],'admin/p2bd/bill-view/{bill_id}', [BillController::class,'P2bdView']);
	Route::match(['get','post'],'admin/p2bd/bill-edit/{bill_id}', [BillController::class,'P2bdEdit']);
	Route::post('admin/p2bd-delete', [BillController::class,'P2bdDelete']);
    Route::get('admin/p2bd/bill-print/{bill_id}',  [BillController::class,'P2bdPrint']);
	Route::get('p2bd/bill/getVendordetails',  [BillController::class,'getVendordetailsp2bd']);
    Route::get('p2bd/bill/getRicedetails/{rice_id}',  [BillController::class,'getRicedetailsp2bd']);
    ...
    //Stock History
    Route::match(['get','post'],'stock/paddyhistory/{pid}/{whid}', [PaddyStockController::class,'PaddyHistory']);
    Route::match(['get','post'],'stock/baghistory/{bid}/{whid}', [BagStockController::class,'BagHistory']);
    Route::match(['get','post'],'stock/accessorieshistory/{aid}/{whid}', [AccessoriesStockController::class,'AccessoriesHistory']);
    Route::match(['get','post'],'stock/ricehistory/{rid}/{whid}', [RiceStockController::class,'RiceHistory']);

//Manage Accessory Manual stock entry
    Route::get('stock/accessory-manual', [AccessoryStockManualController::class,'Index']);
    Route::post('stock/accessory-manual-list', [AccessoryStockManualController::class,'List']);
    Route::match(['get','post'],'stock/create-accessory-manual', [AccessoryStockManualController::class,'Create']);
    Route::match(['get','post'],'stock/update-accessory-manual/{id}', [AccessoryStockManualController::class,'Update']);
    Route::post('stock/delete-accessory-manual/{id}', [AccessoryStockManualController::class,'Delete']);
    ...
    Route::get('admin/other-expense', [OtherExpenseController::class,'Index']);
    Route::post('admin/other-expense-list', [OtherExpenseController::class,'List']);
    Route::match(['get','post'],'admin/create-other-expense', [OtherExpenseController::class,'Create']);
    Route::match(['get','post'],'admin/update-other-expense/{id}', [OtherExpenseController::class,'Update']);
    Route::post('admin/delete-other-expense', [OtherExpenseController::class,'Delete']);
